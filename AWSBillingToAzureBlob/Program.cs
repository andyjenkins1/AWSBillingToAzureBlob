...
namespace AWSBillingWebJob
{
    ...
    class Program
    {
        ...
        private static void Main()
        {
            ...
            Console.WriteLine("AWSBillingWebJob: {0}.", awsSettings.Description);
            ...
            Console.WriteLine("AWSBillingToAzureBlob job has completed sucessfully");
